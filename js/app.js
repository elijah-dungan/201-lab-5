...
function multiply(a, b) { //eslint-disable-line
    ...
    var multProd = a * b;
    var textProd = 'The product of ' + a + ' and ' + b + ' is ' + multProd + '.';

    return [multProd, textProd];
}
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    var prodTwo = multiply(multArr[0], multArr[1])[0];
    var prodThree = multiply(prodTwo, multArr[2])[0];

    var textProdArray = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + prodThree + '.';

    return [prodThree, textProdArray];
}
